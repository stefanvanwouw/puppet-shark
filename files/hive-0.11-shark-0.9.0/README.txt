Apache Hive (TM) 0.11-shark-0.9.0
======================
...
- Hive 0.11-shark-0.9.0 includes changes to the MetaStore schema. If
...
- Hive 0.11-shark-0.9.0 includes new configuration properties. If you
